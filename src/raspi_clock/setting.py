...
class DisplaySettings(object):
    ...
    MENU_TITLE_FONT = ImageFont.truetype(
        os.path.join(RESOURCES_PATH, "font", "LeagueGothic-Regular.otf"), 20
    )
    MENU_OPTIONS_FONT = ImageFont.truetype(
        os.path.join(RESOURCES_PATH, "font", "LeagueGothic-Regular.otf"), 16
    )
