...
class RotaryEncoder():
    ...
    def setup_interrupt(self):
        GPIO.add_event_detect(self.clk, GPIO.FALLING, callback=self.clk_clicked, bouncetime=150)
        GPIO.add_event_detect(self.dt, GPIO.FALLING, callback=self.dt_clicked, bouncetime=150)
