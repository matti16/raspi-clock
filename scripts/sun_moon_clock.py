...
def draw_sun(draw, cx, cy):
    ...
    rays = [
        ...
        [
            (cx - RAY_WIDTH / 2, cy - margin),
            (cx, cy - (margin + RAY_HEIGHT)),
            (cx + RAY_WIDTH / 2, cy - margin),
        ],
        [
            (cx - RAY_WIDTH / 2, cy + margin),
        ...
        [
            (cx + margin, cy - RAY_WIDTH / 2),
            (cx + (margin + RAY_HEIGHT), cy),
            (cx + margin, cy + RAY_WIDTH / 2),
        ],
        [
            (cx - margin, cy - RAY_WIDTH / 2),
    ...
    rays += [
        ...
        [
            (cx + RAY_WIDTH / 2, cy - margin),
            (
                cx + (margin + RAY_HEIGHT) * ANGLED_RAYS_SCALE,
                cy - (margin + RAY_HEIGHT) * ANGLED_RAYS_SCALE,
            ),
            (cx + margin, cy - RAY_WIDTH / 2),
        ],
        [
